...
function TableData({children, className, ...restProps}: DetailedHTMLProps<TdHTMLAttributes<HTMLTableDataCellElement>, HTMLTableDataCellElement>) {
...
function TableHeader({children, className, ...restProps}: DetailedHTMLProps<ThHTMLAttributes<HTMLTableDataCellElement>, HTMLTableDataCellElement>) {
  className = `p-2 ${className ? className : ''}`
...
function financial(x: string | number) {
